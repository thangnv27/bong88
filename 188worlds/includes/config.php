...
if (!defined('THEME_NAME'))
    define('THEME_NAME', "188World");
if (!defined('SHORT_NAME'))
    define('SHORT_NAME', "188world");
...
$options = array(
    ...
    'theme-options' => array(
        ...
        array("type" => "open"),
        array("name" => "Giải trí",
            "desc" => "Danh sách category ID, mỗi ID cách nhau bằng dấu phẩy (,)",
            "id" => SHORT_NAME . "cat_IDs",
            "std" => "",
            "type" => "text"),
...
//            "type" => "textarea"),
        ...
        array("name" => "Link Text",
            "desc" => "Dòng mô tả hiển thị ở phía trên 5 links",
            "id" => "link_text",
            "std" => "",
            "type" => "text"),
        array("name" => "Links 1",
            "desc" => "Nhập URL",
            "id" => SHORT_NAME . "_link1",
            "std" => "",
            "type" => "text"),
        array("name" => "Links 2",
            "desc" => "Nhập URL",
            "id" => SHORT_NAME . "_link2",
            "std" => "",
            "type" => "text"),
        array("name" => "Links 3",
            "desc" => "Nhập URL",
            "id" => SHORT_NAME . "_link3",
            "std" => "",
            "type" => "text"),
        array("name" => "Links 4",
            "desc" => "Nhập URL",
            "id" => SHORT_NAME . "_link4",
            "std" => "",
            "type" => "text"),
        array("name" => "Links 5",
            "desc" => "Nhập URL",
            "id" => SHORT_NAME . "_link5",
            "std" => "",
            "type" => "text"),
        array("type" => "close"),
        array("type" => "submit"),
